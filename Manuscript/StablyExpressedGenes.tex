...
\keywords{RNA-Seq, stably expressed gene, reference gene set, numerical stability measure}



\usepackage{url}
\usepackage{caption}
%\captionsetup[figure]{labelfont={bf},name={Fig.},labelsep=period}  % Figure format
...
\begin{abstract}
	...
	variance component analysis that we explore here is a first step towards understanding the 
	sources and nature of the RNA-Seq count variation. When using a numerical measure to identify 
	stably expressed genes, the outcome	depends on multiple factors: the background sample set 
	and the reference gene set used for count normalization, the technology	used for measuring 
	gene expression, and the specific numerical stability measure used. Since differential 
	expression (DE) is measured by relative frequencies, we argue that DE is a relative concept. We 
	advocate using an explicit reference gene set for count normalization to improve 
	interpretability of DE results, and recommend using a common reference gene set when analyzing 
	multiple RNA-Seq experiments to avoid potential inconsistent conclusions.
\end{abstract}
...
universally stably expressed genes may not exist. \citeauthor{hruz2011refgenes} showed that a 
subset of 
stably
...
\citeauthor{czechowski2005genome}
...
\citeauthor{czechowski2005genome} measured the expression stability of each gene
...
throughout development, \citeauthor{czechowski2005genome} suggested stably expressed
...
\citet{stamova2009identification},  \citeauthor{dekkers2012identification}, 
...
top 1000 most stably expressed genes in each group.  In Fig \ref{cpm}, we
...
\begin{figure}[tbp] \begin{center}
		\begin{subfigure}{0.32\textwidth}
			\centering
		 \includegraphics[width=\linewidth]{FigPeerJ/fig1a.eps}
		 \caption{}
		 \end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\centering
		 \includegraphics[width=\linewidth]{FigPeerJ/fig1b.eps}
		 \caption{}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\centering
			 \includegraphics[width = \linewidth]{FigPeerJ/fig1c.eps}
			 \caption{}	
		\end{subfigure}
		\caption[Histograms of the mean RNA-Seq CPM]{{\small{\label{cpm} 
					...
					most stably expressed genes identified from the seedling (a), leaf (b) 
					and multi-tissue
					(c) groups
	...
	microarray experiments (see Fig.1 of that paper).  
	In Fig.\ref{expressionlevel1}, we compare the expression profiles 
	...
	For each of the 15 genes, Fig.\ref{expressionlevel1} shows the expression levels measured
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}{1.0\textwidth}
			\centering
				\includegraphics[width=14cm,height=6cm]{FigPeerJ/fig2a.eps}
			\caption{}
		\end{subfigure}	
			\begin{subfigure}{1.0\textwidth}
				\centering
					\includegraphics[width=14cm,height=6cm]{FigPeerJ/fig2b.eps} 
				\caption{}
			\end{subfigure}	
				\begin{subfigure}{1.0\textwidth}
					\centering
				\includegraphics[width=14cm,height=6cm]{FigPeerJ/fig2c.eps}
					\caption{}
				\end{subfigure}						
			\caption[Expression profiles of 15 genes as measured by RNA-Seq CPM]{Expression 
				...
				expressed identified by \citeauthor{czechowski2005genome} according to the CV 
				measure 
				from a
	...
	\begin{table}[]
		...
		RNA-Seq data for the 15 genes in Fig.\ref{expressionlevel1}]{Variance components 
			estimated from the multi-tissue group
			RNA-Seq data for the 15 genes in Fig.\ref{expressionlevel1}
	...
	\begin{enumerate}\label{list:L5}
		...
		\citeauthor{vandesompele2002accurate} ; 
		\item[$L_2$:]	
		...
		experiments by \citeauthor{czechowski2005genome} using the CV measure (see Section 
		\ref{subsection:OtherStabilityMeasure}); 
		\item[$L_5$:] 50 stably expressed genes identified by 
		\citeauthor{dekkers2012identification} 
		from 
		microarray
	...
	In Fig.\ref{fig:rankVSrank_RNA}, we plot the recall percentage versus
	...
	\begin{figure}[h!]
		\begin{center}
			\includegraphics[scale=0.55]{FigPeerJ/fig3.eps}
	...
	%\begin{figure}
	%\centering
	%\includegraphics[width=0.7\linewidth]{FigPeerJ/wenn.eps}
	...
	\begin{center} 
		\begin{table}[!ht] 
			...
			\begin{figure}[!ht]
				\begin{center}
					\includegraphics[width=14cm,height=1.5cm]{FigPeerJ/fig4legend.eps}
					\begin{subfigure}{0.32\textwidth}
						\centering
							\includegraphics[width=4.5cm,height=4cm]{FigPeerJ/fig4a.eps}			
						\caption{}
					\end{subfigure}		
						\begin{subfigure}{0.32\textwidth}
							\centering
					\includegraphics[width=4.5cm,height=4cm]{FigPeerJ/fig4b.eps}
							\caption{}
						\end{subfigure}	
							\begin{subfigure}{0.32\textwidth}
								\centering
							\includegraphics[width=4.5cm,height=4cm]{FigPeerJ/fig4c.eps}
								\caption{}
							\end{subfigure}	
					...
					variance]{Distributions (over all genes) of the percentages of the total
						...
						between-experiment variance component, in the seedling (a), the leaf (b), 
						and the multi-tissue groups (c).}
			...
			\begin{figure}[!ht]
				\centering
				%\includegraphics[width=15cm, height= 1.5cm]{FigPeerJ/stackbar_legend.eps}
				\begin{subfigure}{\textwidth}
					\centering
				\includegraphics[width=14cm, height= 7cm]{FigPeerJ/fig5a.eps}
					\caption{}
				\end{subfigure}	
					\begin{subfigure}{\textwidth}
						\centering
						\includegraphics[width=14cm, height= 7cm]{FigPeerJ/fig5b.eps}
						\caption{}
					\end{subfigure}	
				\caption{Stacked bar plots of the three variance components for
					selected genes in the multi-tissue group. (a): 20 genes randomly selected from 
					top 1000 stably expressed genes; (b): 20 genes randomly selected from all 
					the genes.}
				\label{fig:all}
			\end{figure}
			...
			\begin{figure}[!ht]
				\begin{center}
						\begin{subfigure}{0.48\textwidth}
							\centering
							\includegraphics[scale=0.34]{FigPeerJ/fig6a.eps}
								\caption{}
						\end{subfigure}	
						\begin{subfigure}{0.48\textwidth}
							\centering
						\includegraphics[scale=0.34]{FigPeerJ/fig6b.eps}
							\caption{}
						\end{subfigure}	
						\begin{subfigure}{0.48\textwidth}
							\centering
						\includegraphics[scale=0.34]{FigPeerJ/fig6c.eps}
							\caption{}
						\end{subfigure}	
						\begin{subfigure}{0.48\textwidth}
							\centering
						\includegraphics[scale=0.34]{FigPeerJ/fig6d.eps}
							\caption{}
						\end{subfigure}		
					...
					estimated using different reference gene sets]{Matrices of scatter plots of 
						...
						The subfigure (d) shows the normalization factors estimated for a new 
						root experiment (GSE64410, with sample size 48) using the top 10--10,000
...
%			\begin{enumerate}
%				\item Should not be used to acknowledge funders ? that information will appear in a 
%				separate Funding Statement on the published paper.
%				\item As a matter of courtesy, we suggest you inform anyone whom you acknowledge.
%			\end{enumerate}
%			
...
%			
			...
			% \begin{figure}[H]
			%\begin{center}
			%\includegraphics[scale=0.4]{FigPeerJ/C1.eps}
			%\includegraphics[scale=0.4]{FigPeerJ/C2.eps}
			%\includegraphics[scale=0.4]{FigPeerJ/C3.eps}
			...
			% \begin{figure}[h!]
			%\begin{center}
			%\includegraphics[scale=0.5]{./FigPeerJ/rank_sl.eps}
			%\includegraphics[scale=0.5]{./FigPeerJ/rank_st.eps}
			...
			% \begin{figure}[h!]
			%\begin{center}
			%\includegraphics[scale=0.3]{FigPeerJ/mvalue2.eps}
			%\includegraphics[scale=0.3]{FigPeerJ/mvalue3.eps}
