...
\newcommand{\rankcorrelation}{0.97~}
...
layout = ``Single End";  We screened all the Arabidopsis experiments available from the NCBI
...
\begin{table}[]
	...
	\label{table:15genes}
	\begin{tabular}{rp{2cm}p{2cm}p{2cm}p{2cm}p{1cm}}\\ \hline
		Source                        & Gene      & betweeen-sample & between-treatment & between-experiment & Rank  \\  \hline
		\multirow{5}{*}{GLMM}   & AT3G27530 & 0.0045 & 0.0000 & 0.0053 & 12 \\ 
			 & AT1G63110 & 0.0025 & 0.0015 & 0.0102 & 58 \\ 
			 & AT4G02560 & 0.0038 & 0.0018 & 0.0101 & 82 \\ 
			 & AT5G53540 & 0.0025 & 0.0071 & 0.0066 & 93 \\ 
			 & AT1G79280 & 0.0124 & 0.0000 & 0.0038 & 94 \\ \hline
...
and 20 genes randomly selected from 23611 genes. 
...
of six seedling samples from a new experiment (GSE50597, \cite{juntawong2014translational}). The largest Pearson correlation
...
\begin{figure}[!ht]
	\begin{center}
		...
		\includegraphics[scale=0.34]{Figures/norm_GSE50597.eps}
		...
		experiment (GSE50597, with sample size 8) using the top 10--10,000
