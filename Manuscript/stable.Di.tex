...
1, but use genes 3--5 as reference in experiment 2, we will conclude that gene
...
in the two experiments. Note that the DE conclusion will be different in both
experiments depending on the reference genes used: if genes 1--3 are used as
