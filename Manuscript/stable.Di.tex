...
\newcommand{\supptableone}{5~}
\newcommand{\supptabletwo}{6--8~}
\newcommand{\supptablethree}{9~}
\newcommand{\supptablefour}{10~}
...
\begin{abstract}
	...
	depends on multiple factors: the background sample set and the reference gene set used for 
	count normalization, the technology
