...
% above pipeline to results from a pipeline based on Bowtie 2 and TopHat \citep{trapnell2009tophat}, the results
% are consistent in the sense that the variation in read counts from the two
