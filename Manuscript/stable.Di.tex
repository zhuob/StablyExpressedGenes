...
A subtle point we want to make is that a reference set
does not have to be absolutely stable to be useful as a reference set: we can
slightly change our perspective and interpret all DE leaf as relative to the
...
he simple normalization methods discussed earlier (REFs) are
...
researchers have to decide what experiments can be considered comparable. This
