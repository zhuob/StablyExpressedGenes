...
\ref{subsection:OurMethod}, to geNorm $V$ value of
...
\begin{enumerate}
	...
	reference sets, but using a different stability measure ($V$ value in
...
values, column 4 is the gene ranking according to the $V$ value (geNorm
...
The $V$ value and the geNorm differ in ranking Gene1 --- Gene5, where Gene4
and Gene5 are ranked first by the $V$ value and Gene1 and Gene2 are ranked
